...
const fetchData = () => {
    ...
    fetch(`http://localhost:3000/api/admin/courses/${safeAdminId}`)
      .then(res => res.json()).then(data => Array.isArray(data) && setCourses(data));

    fetch(`http://localhost:3000/api/admin/stats/${safeAdminId}`)
      .then(res => res.json()).then(data => setStats(data));

    fetch(`http://localhost:3000/api/admin/finances/${safeAdminId}`)
